<h2><a href="https://www.geeksforgeeks.org/problems/sort-the-array0055/1?page=1&difficulty=Basic&status=unsolved&sortBy=submissions">Sort The Array</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a random set of numbers, Print them in sorted order.</span></p>
